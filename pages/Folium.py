...
**Limitation:** Poor performance (will often produce error message "Your app is
having trouble loading the streamlit_folium.st_folium component" - which
happens in the streamlit_folium documentation as well).''')
...
if 'shapes' not in st.session_state:
    # Import shapefile
    shp_nd = gpd.read_file('data/shapefile_nd/shp_nd.shp')
